    ...
    <div className="flex flex-col items-center space-y-4">
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogTrigger asChild>
          <Button variant="outline" className="text-purple-300 border-purple-300 hover:bg-purple-800 hover:text-purple-100">
        ...
        <DialogContent className="sm:max-w-[425px] bg-gray-800 text-gray-100">
          ...
          <ScrollArea className="h-[300px] w-full rounded-md border border-gray-700 p-4">
            {playlist.map((track) => (
              <div key={track.id} className="flex items-center justify-between py-2 border-b border-gray-700">
                <div>
          ...
          <div className="mt-4 space-y-2">
            ...
            <Input
              ...
              className="bg-gray-700 border-gray-600 text-purple-200"
            />
            <Button onClick={handleAddTrack} className="w-full bg-purple-600 hover:bg-purple-700 text-white">
